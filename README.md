...
🧩 Git for Windows           Motor de control de versiones. 📥 Descargar
⚡ PowerShell 7+             Ejecución de scripts estable.  📥 Descargar
📝 VS Code                   Editor recomendado.            📥 Descargar🚀
...
2️⃣ El Puente de Datos (Symlink)⚠️ IMPORTANTE: Ejecuta PowerShell como Administrador.PowerShell# Reemplaza 'TU_USUARIO' con tu nombre real de Windows
$user = $env:USERNAME
mklink /D "C:\Users\$user\.gemini\antigravity\.agents" "C:\src\antigravity-agents-public"

3️⃣ Activar el Motor de SincronizaciónEl script Sync-Antigravity-Agents.ps1 vigila tus archivos. Configúralo en el Programador de Tareas:Disparador: Al iniciar sesión (At LogOn).Acción: powershell.exeArgumentos: -WindowStyle Hidden -ExecutionPolicy Bypass -File "C:\src\scripts\Sync-Antigravity-Agents.ps1"📂 Estructura del EcosistemaBashC:\src\
